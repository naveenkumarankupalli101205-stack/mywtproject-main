    ...
    <div className="bg-card dark:bg-card rounded-lg border border-border dark:border-border p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <Icon name="Phone" size={20} className="text-primary dark:text-primary mr-2" />
      ...
      <div className="space-y-4">
        {contactList?.length === 0 ? (
          ...
          contactList?.map((contact, index) => (
            <div key={contact?.id} className="border border-border dark:border-border rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  {contact?.isPrimary && (
                    <span className="ml-2 px-2 py-1 bg-primary/10 dark:bg-primary/10 text-primary dark:text-primary text-xs font-medium rounded-full">
                      Primary
                    </span>
                  )}
                </div>
