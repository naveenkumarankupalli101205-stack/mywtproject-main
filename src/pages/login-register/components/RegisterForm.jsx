  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        setSuccessMessage(`A verification email has been sent to ${formData.email}. Please check your inbox to complete your registration.`);
      }
  ...
  if (isSignUpSuccess) {
    return (
      <div className="p-6 bg-card border border-border rounded-lg text-center">
        <Icon name="MailCheck" size={48} className="text-success mx-auto mb-4" />
